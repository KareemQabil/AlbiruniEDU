...
const cardVariants = cva('rounded-lg', {
  variants: {
    variant: {
      default: 'bg-card text-card-foreground border border-border shadow',
      glass: 'glass',
      elevated:
        'bg-card text-card-foreground shadow-lg hover:shadow-xl transition-shadow border border-border',
